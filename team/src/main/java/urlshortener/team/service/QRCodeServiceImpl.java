...
public class QRCodeServiceImpl implements QRCodeService {
    ...
    @Override
    public void generateQRCode(URI uri, int width, int height, OutputStream stream) throws WriterException, IOException {
    ...
    @Override
    public void generateQRCode(URI uri, VCard vcard, int width, int height, OutputStream stream)  throws WriterException, IOException {
        Writer writer = new QRCodeWriter();
